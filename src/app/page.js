...
const nodeResearchLinks = {
  ...
  "black-rocks": {
    ...
    whitepapers: [],
    images: [
      { title: "Atelier Space 1", src: "/images/atelier/EIXR4459.JPG" },
      { title: "Atelier Space 2", src: "/images/atelier/MZWZ3036.JPG" },
      { title: "Atelier Space 3", src: "/images/atelier/PLDF3567.JPG" },
      { title: "Atelier Space 4", src: "/images/atelier/WMSA0536.JPG" },
    ],
    ...
    systems: [
      {
        ...
        nodes: [
          { id: "cow-lane", role: "primary", name: "Cow Lane / Accra", code: "active node", state: "economic engine", phase: "Första operativa workspace och ekonomisk startpunkt.", status: "Cow [...]", evidence: "", facts: [] },
          { id: "black-rocks", role: "future", name: "Black Rocks", code: "planned", state: "planned node", phase: "Observation. Lokal efterfrågan är okänd.", status: "Black Rocks är planerad[...]", evidence: "", facts: [] },
          { id: "winneba", role: "future", name: "Winneba", code: "planned", state: "planned node", phase: "Observation och lärande.", status: "Winneba kan senare kopplas till utbildning och stu[...]", evidence: "", facts: [] },
          { id: "apam", role: "future", name: "Apam", code: "planned", state: "planned node", phase: "Observation. Lokal efterfrågan är okänd.", status: "Apam är en planerad framtida nod som [...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "cape-coast",
        ...
        nodes: [
          { id: "cape-coast", role: "future", name: "Cape Coast", code: "planned", state: "planned node", phase: "Framtida kustreferens.", status: "Cape Coast kan bli relevant för lärande, part[...]", evidence: "", facts: [] },
          { id: "elmina", role: "future", name: "Elmina", code: "optional satellite", state: "optional satellite", phase: "Observation.", status: "Elmina är en optional satellite nära Cape Coas[...]", evidence: "", facts: [] },
          { id: "kakum", role: "future", name: "Kakum / inland learning node", code: "optional satellite", state: "optional satellite", phase: "Inland learning observation.", status: "Kakum kan l[...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "volta",
        ...
        nodes: [
          { id: "ho", role: "future", name: "Ho", code: "planned", state: "future node", phase: "Observation.", status: "Ho kan senare kopplas till lärande eller lokal service, men ingen modell [...]", evidence: "", facts: [] },
          { id: "hohoe", role: "future", name: "Hohoe", code: "planned", state: "future node", phase: "Observation.", status: "Hohoe är en framtida observationspunkt i Volta-systemet.", evidence: "", facts: [] },
          { id: "biakpa", role: "future", name: "Biakpa", code: "planned", state: "future node", phase: "Mountain observation.", status: "Biakpa kan vara relevant för miljö, svalka och lärande[...]", evidence: "", facts: [] },
          { id: "wli", role: "future", name: "Wli / mountain-water node", code: "optional", state: "optional satellite", phase: "Mountain-water observation.", status: "Wli är optional och ska ba[...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "sweden",
        ...
        nodes: [
          { id: "gothenburg", role: "future", name: "Gothenburg", code: "planned", state: "partner node", phase: "Partner and coordination observation.", status: "Gothenburg kan fungera som svens[...]", evidence: "", facts: [] },
          { id: "umea", role: "future", name: "Umeå", code: "planned", state: "future node", phase: "Northern observation.", status: "Umeå är en möjlig framtida svensk nod för kunskap och pa[...]", evidence: "", facts: [] },
          { id: "stockholm", role: "future", name: "Stockholm", code: "planned", state: "future node", phase: "Institutional observation.", status: "Stockholm kan vara relevant för institutionel[...]", evidence: "", facts: [] },
          { id: "lund", role: "future", name: "Lund / academic node", code: "optional", state: "optional academic node", phase: "Academic observation.", status: "Lund är optional och kopplas fr[...]", evidence: "", facts: [] },
        ],
      },
    ],
  },
    ...
    systems: [
      {
        ...
        nodes: [
          { id: "cow-lane", role: "primary", name: "Cow Lane / Accra", code: "active node", state: "economic engine", phase: "First operational workspace and economic starting point.", status: "C[...]", evidence: "", facts: [] },
          { id: "black-rocks", role: "future", name: "Black Rocks", code: "planned", state: "planned node", phase: "Observation. Local demand is unknown.", status: "Black Rocks is planned as a po[...]", evidence: "", facts: [] },
          { id: "winneba", role: "future", name: "Winneba", code: "planned", state: "planned node", phase: "Observation and learning.", status: "Winneba may later connect to education and student[...]", evidence: "", facts: [] },
          { id: "apam", role: "future", name: "Apam", code: "planned", state: "planned node", phase: "Observation. Local demand is unknown.", status: "Apam is a planned future node that requires [...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "cape-coast",
        ...
        nodes: [
          { id: "cape-coast", role: "future", name: "Cape Coast", code: "planned", state: "planned node", phase: "Future coastal reference.", status: "Cape Coast may become relevant for learning,[...]", evidence: "", facts: [] },
          { id: "elmina", role: "future", name: "Elmina", code: "optional satellite", state: "optional satellite", phase: "Observation.", status: "Elmina is an optional satellite near the Cape Co[...]", evidence: "", facts: [] },
          { id: "kakum", role: "future", name: "Kakum / inland learning node", code: "optional satellite", state: "optional satellite", phase: "Inland learning observation.", status: "Kakum can b[...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "volta",
        ...
        nodes: [
          { id: "ho", role: "future", name: "Ho", code: "planned", state: "future node", phase: "Observation.", status: "Ho may later connect to learning or local services, but no model is proven[...]", evidence: "", facts: [] },
          { id: "hohoe", role: "future", name: "Hohoe", code: "planned", state: "future node", phase: "Observation.", status: "Hohoe is a future observation point in the Volta system.", evidence: "", facts: [] },
          { id: "biakpa", role: "future", name: "Biakpa", code: "planned", state: "future node", phase: "Mountain observation.", status: "Biakpa may later become relevant for environment, cooling[...]", evidence: "", facts: [] },
          { id: "wli", role: "future", name: "Wli / mountain-water node", code: "optional", state: "optional satellite", phase: "Mountain-water observation.", status: "Wli is optional and should [...]", evidence: "", facts: [] },
        ],
      },
      {
        id: "sweden",
        ...
        nodes: [
          { id: "gothenburg", role: "future", name: "Gothenburg", code: "planned", state: "partner node", phase: "Partner and coordination observation.", status: "Gothenburg may serve as a Swedis[...]", evidence: "", facts: [] },
          { id: "umea", role: "future", name: "Umeå", code: "planned", state: "future node", phase: "Northern observation.", status: "Umeå is a possible future Swedish node for knowledge and pa[...]", evidence: "", facts: [] },
          { id: "stockholm", role: "future", name: "Stockholm", code: "planned", state: "future node", phase: "Institutional observation.", status: "Stockholm may become relevant for institutiona[...]", evidence: "", facts: [] },
          { id: "lund", role: "future", name: "Lund / academic node", code: "optional", state: "optional academic node", phase: "Academic observation.", status: "Lund is optional and mainly conne[...]", evidence: "", facts: [] },
        ],
      },
    ],
  },
            ...
            <>
              ...
              {selectedNodeLinks ? (
                <>
                  ...
                  {selectedNodeLinks.images?.length ? (
                    <div className="node-link-group">
                      <p className="panel-eyebrow">Images</p>
                      <div className="node-image-gallery">
                        {selectedNodeLinks.images.map((image) => (
                          <div key={image.src} className="node-image-item">
